#!/bin/bash -l
#$ -N bmvc_afhq_128_no_lambda_ciadv
#$ -j y
#$ -l h=virya
#$ -l h_vmem=250G
# set environment
...
python main.py --mode distill_train --num_domains 3 --w_hpf 0 --batch_size 8 --num_workers 4 --resume_iter 0  --alpha 128 --efficient 1 \
               --lambda_reg 1 --lambda_sty 1 --lambda_ds 2 --lambda_cyc 1 --f_lr 1e-4  --D_channels 128 --lambda_ciadv 0 \
               ...
               --checkpoint_dir expr/bmvc_afhq_128_no_lambda_ciadv --print_every 10 --save_every 10000
